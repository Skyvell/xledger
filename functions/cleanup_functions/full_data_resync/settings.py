...
FINANCIAL_RESULTS_END_PERIOD = int(get_previous_month_yy_mm())

# Generated periods based on start and end period.
FINANCIAL_RESULTS_PERIODS = generate_periods(FINANCIAL_RESULTS_START_PERIOD, FINANCIAL_RESULTS_END_PERIOD)