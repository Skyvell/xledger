...
from functions.flexlink_functions.cost_categories.settings import (
    COLUMN_DTYPES
)
...
def report(myTimer: func.TimerRequest) -> None:
    ...
    data = flex_link_reader.read_xlsx_flex_link(config.cost_categories_flex_link, COLUMN_DTYPES)
