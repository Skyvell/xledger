...
class DataSynchronizer:
    ...
    def _full_syncronization(self, filename: str = None) -> None:
        ...
        if self.add_mutated_at_to_columns:
            items.add_key_value_to_items("mutatedAt", generate_iso_8601_timestamp(current_time))
        ...
        self.data_lake_writer.write_data(f"full_sync-{get_current_time_for_filename(current_time)}-{self.name}.parquet", items_transformed)
